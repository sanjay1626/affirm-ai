// ============================================================
// DENO MIRROR of src/utils/onboardingTagMap.ts
//
// The Edge Function (Deno) cannot import from the React Native client,
// so this is a hand-kept copy. The data maps below MUST stay byte-identical
// to the client module — onboardingTagMap.parity.test.ts asserts that.
//
// >>> If you change a mapping, change it in BOTH files. <<<
// ============================================================
